...
<html lang="en"><head>
	...
	<script type="text/javascript" src="./../js/js_quanly_giaphong.js"></script>
				...
				<div class="col-xs-12 col-sm-12 col-md-10 col-lg-10 benphai">
					...
					<div class="container-fluid">
						...
						<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
							<input type="button" class="btn btn-basic btn-block" name="them_khach_hang" value="Thêm mới" data-toggle="modal" data-target="#them_khach_hang1">
						</div>
						</div><!-- end thaydoi1 -->
					...
					<div class="modal-body _1themtoanha">
						<form action="" id="form_themkhach_hangmoi" name="form_themkhach_hangmoi" 	method="POST" role="form" class="_1themphong1 "  enctype="multipart/form-data" data-confirm="Bạn có chắn muốn cập nhật lại thông tin này?">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 hoten_cb_sua ">
								...
								<?php
									$r=mysqli_fetch_array(mysqli_query($conn,"SELECT ma_khach_hang FROM giaphong order by ma_khach_hang DESC LIMIT 1"));
									$ma1=$r['ma_khach_hang'];
									
									$mnvmoi= $ma1+1;
								?>
								<input style="width:50%" type="text" name="ma_khach_hang_themmoi123" id="ma_khach_hang_themmoi123" class="form-control chuinhoa " value="<?php echo $mnvmoi ;?>"  required="" placeholder="Nhập mã giá phòng"  readonly=""/>
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 hoten_cb_sua">
								<label>Họ giá phòng</label>
								<input  name="ho_khach_hangthemmoi_12" id="ho_khach_hangthemmoi_12" class="form-control chuinthuong" rows="1" required="" placeholder="Nhập họ giá phòng" >
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 hoten_cb_sua">
								<label>Tên giá phòng</label>
								<input  name="ten_khach_hangthemmoi_12" id="ten_khach_hangthemmoi_12" class="form-control chuinthuong" rows="1" required="" placeholder="Nhập tên giá phòng" >
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 hoten_cb_sua">
					...
					<div class="modal-body">
						<form action="" id="from_suathongtin_khach_hang" name="from_suathongtin_khach_hang" 	method="POST" role="form" class="_1themphong1 " enctype="multipart/form-data" data-confirm="Bạn có chắn muốn cập nhật lại thông tin này?">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 hoten_cb_sua ">
								...
								<input style="width:50%" type="text" name="ma_khach_hang_sua_12" id="ma_khach_hang_sua_12" class="form-control chuinhoa " value=""  required="" readonly="" placeholder="Nhập mã giá phòng"  />
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 hoten_cb_sua">
								<label>Họ giá phòng</label>
								<input  name="ho_khach_hang_sua_12" id="ho_khach_hang_sua_12" class="form-control chuinthuong" rows="1" required="" placeholder="Nhập họ giá phòng" >
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 hoten_cb_sua">
								<label>Tên giá phòng</label>
								<input  name="ten_khach_hang_sua_12" id="ten_khach_hang_sua_12" class="form-control chuinthuong" rows="1" required="" placeholder="Nhập tên giá phòng" >
							</div>
							<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 hoten_cb_sua">
								<label>Ngày sinh</label>
