...
include 'conn.php';
	...
	$selecet_nhanvien = mysqli_query($conn, "SELECT * FROM nhanvien WHERE nhanvien.xoa=0 and nhanvien.id='$_SESSION[idnv]' order by nhanvien.ten_nhan_vien, nhanvien.ho_nhan_vien");
